...
$workexp = [
    [
        'work_name' => 'Физико-технический институт',
        'work_date' => '01.09.2020 - 10.12.2021',
        'work_descrip' => 'Младший научный сотрудник',
    ],
    [
        'work_name' => 'ЧТУП Люди и Цифры',
        'work_date' => '13.12.2021 - 14.08.2022',
        'work_descrip' => 'Оператор станка лазерной резки',
    ],
    [
        'work_name' => 'СК Белросстрах',
        'work_date' => '10.09.2017 - настоящее время',
        'work_descrip' => 'Страховой агент',
    ],
];
<!DOCTYPE html>
<html>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $workexp[$i]['work_name'];?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workexp[$i]['work_date'];?> <span
                class="w3-tag w3-teal w3-round">Current</span></h6>
            <p><?php echo $workexp[$i]['work_descrip'];?></p>
            <hr>
          </div>
          <?php endfor;?>
        </div>
